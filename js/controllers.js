...
class Cart extends List{//класс списка товаров в корзине (потомок класса List)
...
class CartItem extends Item{// класс элемента в корзине
    constructor(el){
        super(el);
...
console.log (cart.allProducts)// пустой
